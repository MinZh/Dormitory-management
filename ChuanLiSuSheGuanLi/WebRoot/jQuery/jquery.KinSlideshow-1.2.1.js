...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   rootWidth:0,
		   btnID:undefined,
		   btn:{btn_bgColor:"#666666",btn_bgHoverColor:"#CC0000",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:1,btn_bgAlpha:0.7,btn_radius:0,btnWidth:"18px",btnHeight:"18px",btnFontSize:12}
	  },settings);
	  var titleBar_Bak = {titleBar_height:40,titleBar_bgColor:"#000000",titleBar_alpha:0.5}
	  var titleFont_Bak = {TitleFont_size:12,TitleFont_color:"#FFFFFF",TitleFont_family:"Verdana",TitleFont_weight:"bold"}
	  var btn_Bak = {btn_bgColor:"#666666",btn_bgHoverColor:"#CC0000",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:1,btn_bgAlpha:0.7,btn_radius:0,btnWidth:"18px",btnHeight:"18px",btnFontSize:12} 
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 var btnBoxAlign = "" ;
			 var btnIDCustom = "";
			 switch(settings.btnAlign){
			 	case "left":btnBoxAlign="left:10px;";break;
			 	case "center":{
			 		btnBoxAlign = "right:10px;";
			 		btnIDCustom="id = '"+settings.btnID+"'";
		 		}break;
			 	case "right":btnBoxAlign="right:10px;";break;
			 	default : btnBoxAlign = "right:10px;";break;
			 }
			 $(ksthis).append("<div class='KSS_btnBox' "+btnIDCustom+" style='position:absolute;"+btnBoxAlign+"bottom:5px; z-index:100'></div>");
			 ...
			 $(ksbs+" .KSS_btnBox #btnlistID li").css({'border-radius':settings.btn.btn_radius,listStyle:"none",float:"left",width:settings.btn.btnWidth,height:settings.btn.btnHeight,borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:3,fontSize:settings.btn.btnFontSize,fontFamily:settings.btn.btn_fontFamily,lineHeight:"18px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
			 ...
			 switch(settings.btnAlign){
			 	case "center":{
			 		var center = (settings.rootWidth-settings.btn.btnWidth.replace("px","")*KSS_imgaeLength)/2;
		 			$('#'+settings.btnID).css({left:center+'px'});
		 		}break;
			 }
		 };
	 };
